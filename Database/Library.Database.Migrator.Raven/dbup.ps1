...
$response = curl -s -S -w "%{response_code}" -X PUT http://127.0.0.1:8080/admin/cluster/node?url=http://library-two:8081
...
$response = curl -s -S -w "%{response_code}" -X PUT http://127.0.0.1:8080/admin/cluster/node?url=http://library-three:8082
